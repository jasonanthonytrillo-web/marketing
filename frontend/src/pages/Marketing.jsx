  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white selection:bg-primary-500/30 overflow-x-hidden">
      ...
      <section className="relative pt-40 pb-20 px-6 overflow-hidden">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[600px] bg-primary-500/10 blur-[120px] rounded-full z-0" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          ...
          >
            ELEVATE <br />
            <span className="bg-gradient-to-r from-white via-surface-300 to-surface-500 bg-clip-text text-transparent uppercase">
              The Standard.
            </span>
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-lg md:text-2xl text-surface-400 max-w-3xl mx-auto mb-12 leading-relaxed font-medium"
          >
            Experience a cinematic, real-time ecosystem designed for visionaries who want to lead, not just manage. Seamless, stunning, and smarter than ever.
          </motion.p>
